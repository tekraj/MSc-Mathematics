...
The region of integration is the shaded rectangle in Figure~\ref{fig:6b}.
\begin{figure}[H]
\centering
\begin{tikzpicture}[scale=1.5]
  ...
  \fill[gray!30] (1,0) rectangle (2,2);
  \draw[dashed] (1,0) -- (1,2);
  \draw[dashed] (0,2) -- (2,2);
...
\end{tikzpicture}
\caption{Shaded region: $X \ge 1$, $Y \le 2$}
\label{fig:6b}
\end{figure}
...
The support triangle and the region $X+Y>1$ are shown in Figure~\ref{fig:8}.
\begin{figure}[H]
\centering
\begin{tikzpicture}[scale=4]
  ...
  \draw[thick] (0,0) -- (1,1);
  \draw[dashed] (1,0) -- (0,1) node[midway, above left] {$x+y=1$};
  \fill[gray!30] (0.5,0.5) -- (0,1) -- (1,1) -- cycle;
  \draw (1,0) node[below] {$1$};
  \draw (0,1) node[left] {$1$};
  \draw (0,0) node[below left] {$0$};
  \draw (0.5,0.5) node[below right] {$0.5$};
  \draw (1,1) node[above right] {$(1,1)$};
\end{tikzpicture}
\caption{Support $0<x<y<1$ (triangle) and region $X+Y>1$ (shaded).}
\label{fig:8}
\end{figure}
...
The region $X+Y<1$ inside the rectangle $[0,1]\times[0,2]$ is shown in Figure~\ref{fig:10d}.
\begin{figure}[H]
\centering
\begin{tikzpicture}[scale=3]
  \draw[->] (-0.1,0) -- (1.3,0) node[right] {$x$};
  \draw[->] (0,-0.1) -- (0,2.3) node[above] {$y$};
  ...
  \draw (0,2) node[left] {$2$};
  \draw (0,1) node[left] {$1$};
  \draw (0.5,0.5) node {$X+Y<1$};
\end{tikzpicture}
\caption{Region for $X+Y<1$ inside the support $0<x<1, 0<y<2$.}
\label{fig:10d}
\end{figure}
\begin{align*}
...
\textbf{(a) Find the value of the constant $K$.}
The support is the shaded triangle in Figure~\ref{fig:11}.
\begin{figure}[H]
\centering
\begin{tikzpicture}[scale=2]
  \draw[->] (-0.2,0) -- (2.5,0) node[right] {$x$};
  \draw[->] (0,-0.2) -- (0,2.5) node[above] {$y$};
  \fill[gray!20] (0,0) -- (2,0) -- (2,2) -- cycle;
  \draw[thick] (0,0) -- (2,0) -- (2,2) -- cycle;
  \draw[thick] (0,0) -- (2,2) node[midway, above left] {$y=x$};
  \draw (2,0) node[below] {$2$};
  \draw (0,2) node[left] {$2$};
  \draw (2,2) node[right] {$(2,2)$};
  \draw (0,0) node[below left] {$0$};
\end{tikzpicture}
\caption{Support: $0<y<x<2$ (shaded).}
\label{fig:11}
\end{figure}
...
The region is a sub‑rectangle of the infinite strip (Figure~\ref{fig:12d}).
\begin{figure}[H]
\centering
\begin{tikzpicture}[scale=3]
  ...
  \draw[thick] (1,0) -- (1,2.2);
  \fill[gray!30] (0,1) rectangle (0.5,2.2);
  \draw[dashed] (0,1) -- (1,1);
  \draw[->] (0,2.2) -- (0,2.5);
  \draw[->] (1,2.2) -- (1,2.5);
  ...
  \draw (0,1) node[left] {$1$};
\end{tikzpicture}
\caption{Support $0<x<1, y>0$ and region $0<X<\frac{1}{2}, Y>1$ (shaded).}
\label{fig:12d}
\end{figure}
